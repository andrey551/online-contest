...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b'SubmissionTaskResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\"'
    b'A\n\x17\x43reateSubmissionRequest\x12\x0f\n\x07user_id\x18\x01 \x01'
    b'(\t\x12\x15\n\rlaboratory_id\x18\x02 \x01(\t\"1\n\x18\x43'
    b'reateSubmissionResponse\x12\x15\n\rsubmission_id\x18\x01 \x01(\t2\xaf\x01\n\x15'
    b'SubmissionTaskService\x12G\n\x14HandleSubmissionTask\x12\x16'
    b'.SubmissionTaskRequest\x1a\x17.SubmissionTaskResponse\x12M\n\x16'
    b'HandleCreateSubmission\x12\x18.CreateSubmissionRequest\x1a\x19'
    b'.CreateSubmissionResponseB\x19\n\x17\x63om.tad.submission.grpcb\x06proto3')
